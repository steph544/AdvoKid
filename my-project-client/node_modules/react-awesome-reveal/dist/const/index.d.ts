...
export declare type FlipDirection = 'vertical' | 'horizontal' | undefined;
export declare type RotateDirection = 'top-left' | 'top-right' | 'bottom-left' | 'bottom-right' | undefined;
